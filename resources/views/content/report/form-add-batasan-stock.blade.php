...
<div class="row">
  <div class="col-xl-6">
    <div class="card mb-4">
      ...
      @endif
        <form action="{{route('process-add-item-batasan-stock')}}" method="POST" >
        @csrf
          <div class="mb-3">
            <label class="form-label" for="users">Users</label>
            <select  class="form-control selectdua" name="users">
          ...
          <div class="mb-3">
            <label class="form-label" for="batasan_stock">Batasan Stock</label>
            <input type="text" class="form-control" name="batasan_stock"/>
            </div>
